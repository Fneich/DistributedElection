...
public class AsymmetricCryptography {
	...
	public static void main(String[] args) throws Exception {
		...
		if (new File("./text.txt").exists()) {
			ac.encryptFile(ac.getFileInBytes(new File("./text.txt")), 
				new File("./text_encrypted.txt"),privateKey);
			ac.decryptFile(ac.getFileInBytes(new File("./text_encrypted.txt")),
				new File("./text_decrypted.txt"), publicKey);
		} else {
